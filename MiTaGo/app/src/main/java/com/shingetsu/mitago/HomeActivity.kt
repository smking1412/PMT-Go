...
//        }
    ...
    private fun init() {
        ...
        val txtPoint = headerView.findViewById<View>(R.id.tv_point_value) as TextView
        ...
        txtPoint.setText(Common.currentUser!!.point.toString())
        ...
        builder.setTitle(resources.getString(R.string.change_avatar))
            ...
            .setPositiveButton(resources.getString(R.string.change)) { dialogInterface, i ->
                if (imageUri != null) {
                    waitingDialog.show()
                    val avatarFolder =
                        storageReference.child("avatarRider/" + FirebaseAuth.getInstance().currentUser!!.uid)
